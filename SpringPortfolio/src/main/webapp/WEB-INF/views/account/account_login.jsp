<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<meta charset="utf-8">
<link rel="stylesheet" href="/resources/css/account/account_login.css"> 
...
<script type="text/javascript" src="/resources/js/account/account_login.js"></script>
 <section>
  <video id="slider" autoplay  loop>
      <source src="/resources/common/storage/video/blueming.mp4" type="video/mp4">
    </video>

    <ul class="navigation">
      <li  id="first" first='/resources/common/storage/video/blueming.mp4' onclick="videoURL('/resources/common/storage/video/blueming.mp4')" ><img src="/resources/common/storage/image/blueming.jpg"></li>
      <li onclick="videoURL('/resources/common/storage/video/Kassy.mp4')"><img src="/resources/common/storage/image/kassy.jpg"></li>
