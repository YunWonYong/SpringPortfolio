...
주소:<input type="text" name="address1" size="45" id="sample6_address" placeholder="주소" value="${dto.address1}"><br>
상세주소:<input type="text" name="address2" size="45" id="sample6_address2" placeholder="상세주소" value="${dto.address2}"><br>
보유기술:<label for="s1">
...
사진변경:<input type="file" name="fileMF"><br>
