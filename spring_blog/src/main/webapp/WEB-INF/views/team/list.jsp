...
<c:when test="${fn:length(list)==0 }">
	...
	<c:forEach items="${list}" var="dto">
			<tr>
				...
				<td>${dto.phone }</td>
				<td>${dto.skillstr }</td>
				<td><img class="timg" src='${pageContext.request.contextPath }/team/storage/${dto.filename }'></td>
				
				<td><a href="javascript:update('${dto.no }')">수정</a>/<a href="javascript:del('${dto.no }','${dto.filename }')">삭제</a></td>		
			</tr>
