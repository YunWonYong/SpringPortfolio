...
<body>
	...
	<div style="background-color: #EEEEEE;">
		...
		<table class="toptable">
			...
			<tr>
				<td><img style="width: 1200px; height: 300px;" src="${pageContext.request.contextPath }/images/main-03.jpg"
					class="img">
				</td>
			</tr>
			<tr>
				<td class="td">
			      ...
			      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Community<span class="caret"></span></a>
			       <ul class="dropdown-menu">
					 ...
					 <li><a href="${pageContext.request.contextPath }/images/list">Images</a></li>
					 <li><a href="${pageContext.request.contextPath }/notice/list?nowPage=1">공지사항</a></li>
