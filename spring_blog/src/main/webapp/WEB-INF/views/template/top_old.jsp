	...
	<div style="background-color: #EEEEEE;">
		...
		<table class="toptable">
			...
			<tr>
				...
				<td class="td"><img src="${pageContext.request.contextPath }/images/main-03.jpg"
					class="img"></td>
				...
				<td class="td">
					...
					<nav>
						<ul id="menu">
							...
							<li><a href="${pageContext.request.contextPath }/bbs/list">bbs목록</a></li>
							<li><a href="${pageContext.request.contextPath }/bbs/create">bbs글생성</a></li>
							<li><a href="${pageContext.request.contextPath }/team/list">팀목록</a></li>
							<li><a href="${pageContext.request.contextPath }/team/create">팀글생성</a></li>
							<li><a href="${pageContext.request.contextPath }/images/list">이미지목록</a></li>
							<li><a href="${pageContext.request.contextPath }/images/create">이미지글생성</a></li>
							...
							<li><a href="${pageContext.request.contextPath }/member/login">로그인</a></li>
    						 ...
    						 <li><a href="${pageContext.request.contextPath }/member/read">마이페이지</a></li>
